...
public class GmallCacheAspect {
   ...
   /* @SneakyThrows
    ...
    public Object example(ProceedingJoinPoint joinPoint){
        ...
        String skuId = Arrays.asList(args).toString();
        String key = prefix + skuId;

        try {
            object = example2(key, signature);
            if(object == null){
    ...
    public Object example2(String key, MethodSignature signature){
...
//                            Object object1 = returnType.newInstance();
