...
public class GwareServiceImpl implements GwareService {
    ...
    public Map<String, List<String>> getWareSkuMap(List<String> skuIdlist) {
        ...
        /*for (WareSku wareSku : wareSkuList) {
            if(!wareSkuMap.containsKey(wareSku.getWarehouseId())){
                wareSkuMap.put(wareSku.getWarehouseId(), new ArrayList<>());
            }
            wareSkuMap.get(wareSku.getWarehouseId()).add(wareSku.getSkuId());
        }*/
        return wareSkuMap;
